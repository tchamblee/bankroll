...
class EvolutionaryAlphaFactory:
    ...
    def update_hall_of_fame(self, candidates, gen, horizon=None):
        ...
        Pruning and diversity checks are deferred to the final selection phase.
        """
        ...
        for i, cand in enumerate(candidates):
            ...
            phase_1 = max(5, int(self.generations * 0.30)) 
            ...
            # Add to HOF (Simplified: No on-the-fly correlation pruning)
        ...
        # Cap Size (Keep top 2000 strategies to ensure we don't OOM while maintaining broad diversity)
        if len(self.hall_of_fame) > 2000:
            self.hall_of_fame = self.hall_of_fame[:2000]
