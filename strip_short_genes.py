...
def main():
    parser = argparse.ArgumentParser(description="Strip SHORT genes from a strategy and save as a new candidate.")
    ...
    new_name = f"{args.name}_LongOnly"
    new_strat['name'] = new_name
    new_strat['short_genes'] = [] # STRIP SHORT GENES
    ...
    new_strat['modification'] = 'strip_short_genes'
    ...
    print(f"✅ Created '{new_name}' (Long Only) and added to candidates.")
